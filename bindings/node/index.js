import { ts_protect_secret, ts_generate_verification_request, ts_generate_verification_response, ts_verify_share_response } from "derec-library";
...
let some_channel = 1n;
console.log("ts_protect_secret: ", shares.value);
